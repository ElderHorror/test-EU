'use client'
import { Box, Button, Center, Flex, FormControl, FormErrorMessage, Image, Input, Text, Textarea, useToast } from "@chakra-ui/react"
              ...
              <Center flexDirection={"column"}>
                ...
                >
                  ...
                  <Field
                    ...
                    width={{ base: '347px', lg: '600px' }}
                    size={'sm'} borderRadius={'none'}
                    placeholder='YOUR EMAIL' textColor={'black'}
                    _placeholder={{ fontSize: '10px', mt: '1rem', color: 'black' }}
                    type='text'
                    id='email'
                    sx={{
