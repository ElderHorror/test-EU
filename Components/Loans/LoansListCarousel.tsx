...
export default function LoansListCarousel() {
  const loansBody = [
    ...
    },
    {
      ...
      text: "The period between your arrival in a new country and the disbursement of your scholarship stipend can be financially challenging. Our Settler's Saftey Net Loan offers you a finnacial cushion to cover essential expenses such as initial groceries, transportation an other immediate needs. it's your saftey net during those critical early days in your new enviroment. ",
      smHeading: "T&C Apply",
      tC: "Repayment Term: 2 months",
